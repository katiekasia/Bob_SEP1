...
/**
 * The class is responsable for  writing and modifying project data to XML files.
 * Provides methods to create, append, and remove project information from the XML file.
...
{
  /**
   * Loads an existing XML document from the file path or creates a new document if it doesn't exist.
   * @param filePath The file path for the XML document.
   * @return The loaded or newly created Document object.
   */
  ...
  /**
   * Appends a list of projects to the existing XML file or creates a new file if it doesn't exist.
   * @param projects The list of Project objects to append to the XML file.
   * @param filePath The file path for the XML document.
   */
    ...
    try {
      ...
      for (Project project : projects)
      {
        ...
        if (!existingProjectIDs.contains(currentID))
        {
          ...
          //for the defaults and specific details to every project
  ...
  /**
 * Removes a selected project from an existing XML file based on the project's ID.
 * @param projectToRemove The Project object to remove from the XML file.
 * @param filePath The file path for the XML document.
 ...
 */
  ...
  /**
   * Saves the Document object to an XML file at the specified file path.
   * @param doc The Document object to be saved.
   * @param filePath The file path for the XML document.
   * @throws TransformerException If an error occurs during the transformation and serialization process.
   */
